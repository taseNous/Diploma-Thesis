...
def Clock_Cycles(x, y, i):
    ...
    if x>0:
        ...
        if pe_flag >= len(Instr_Cache):
            ...
            f.write(PE_print4)
            f.close()
        elif i+1 in bre_index or i+1 in bre_array_not:
            ...
            if i in bre_index:
                ...
                f.close()
                # kAE[0] = w1.opcode
                # if int(w1.r1[1], 16) - int(w1.r2[1], 16) == 0:
                #     # d_index.clear()
                #     if bre_pos_index:
                #         if i == bre_pos_index[0]:
                #             d_value.clear()
                ...
                # if choose_bre == 1:
                #     if int(w1.r1[1], 16) - int(w1.r2[1], 16) == 0:
                #         bre_index.append(i+2)
                #         print("bre_index")
                #         print(bre_index)
                #     elif int(w1.r1[1], 16) - int(w1.r2[1], 16) != 0:
                #         bre_array_not.append(i+2)
                #         print("bre_array_not")
                #         print(bre_array_not)
                # elif choose_bre == 2:
                #     if int(w1.r1[1], 16) - int(w1.r2[1], 16) == 0:
