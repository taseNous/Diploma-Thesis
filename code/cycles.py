...
def Clock_Cycles(x, y, i):
    ...
    global var_counter1, var_counter2, var_counter3, var_counter4, var_counter5, ae_flag, x_flag, t, tt, q, v, pm_load1, pm_load2, pm_store1, pm_store2
