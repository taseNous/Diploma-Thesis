...
def create_button4_window(menu_window, screen_width, screen_height):
    ...
    def select_option():
        ...
        try:
            ...
            if user_input in (1, 2, 3, 4):
                ...
                start_over_method += 1
                messagebox.showinfo("Επιλογή Μεθόδου", f"Επιλέξατε {choose}")
            else:
                raise ValueError
        except ValueError:
            messagebox.showerror("Σφάλμα!", "Παρακαλώ, επιλέξτε μόνο (1, 2, 3, ή 4)")
    ...
    def select_option_bre():
        ...
        try:
            ...
            if user_input in (1, 2):
                ...
                start_over_method += 1
                messagebox.showinfo("Επιλογή Μεθόδου", f"Επιλέξατε {choose_bre}")
            else:
                raise ValueError
        except ValueError:
            messagebox.showerror("Σφάλμα!", "Παρακαλώ, επιλέξτε μόνο (1 ή 2)")
    ...
    labels_text = ["No Operation (NOP) - 1", "Πάγωμα - 2", "Παροχέτευση με NOP - 3", "Παροχέτευση με Πάγωμα - 4"]
    ...
    input_label = tk.Label(input_frame, text="Επιλέξτε (1, 2, 3, ή 4):", font=("Arial", int(18 * font_scale)), bg="#2E2E2E", fg="white")
    ...
    select_button = tk.Button(button_frame, text="Επιλογή", font=("Arial", int(18 * font_scale)), fg="black", bg="#61afef", activebackground="#4fa3e2", activeforeground="white", command=select_option)
    ...
    bre_label1 = tk.Label(
        new_frame,
        text="Διακλάδωση (BRE) με πάγωμα - 1",
    ...
    bre_label2 = tk.Label(
        new_frame,
        text="Διακλάδωση (BRE) με πρόβλεψη - 2",
        font=("Arial", int(20 * font_scale)),
        bg="#2E2E2E", fg="white"
    )
    ...
    exit_button = tk.Button(button_frame, text="Έξοδος", font=("Arial", int(18 * font_scale)), bg="#ff6666", fg="black", activebackground="#cc0000", activeforeground="white", command=lambda: close_button4_open_menu())
