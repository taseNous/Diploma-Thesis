...
from vars import r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, d, none
import gui_vars, dependencies,method, cycles, grades, alm
...
try:
    ...
    def applytoLabel1(canvas, screen_width, screen_height, z, i):
        global entolh_index, position_y, d, instr_move, current_y, next_instr, time, change_pe_flag, change_pe_flag1, index, indexx

        choose = method.choose
        bre_index = cycles.bre_index
        bre_index_pred = cycles.bre_index_pred
        instr_move = grades.instr_move
        next_instr = grades.next_instr
