...
from vars import r, r2, r3, r4, counter
...
def pipeline_program(root):
    ...
    def update_file_content():
        ...
        for i in range(z):
            ...
            # if choose_bre == 1:
            #     dependencies.depend_bre(i)
            # elif choose_bre == 2:
            #     dependencies.depend_bre_pred(i)
            # if choose == 1:
            #     dependencies.depend_nop(i)
            # elif choose == 2:
            #     dependencies.depend_freeze(i)
            # elif choose == 3:
            #     dependencies.depend_bypassing_nop(i)
            # elif choose == 4:
            #     dependencies.depend_bypassing_freeze(i)
    ...
    previous_button = tk.Button(
        top_left_canvas, 
        text="Προηγούμενος Κύκλος", 
        font=("Arial", font_size), 
        fg="black", 
        bg="#9370DB", 
        command=update_file_content1
    )
