# Creation of the schema in the top left canvas

import cycles, method

from gui_vars import Instr_Cache

#ΠολυπλέκτηςΑ
def pipeline (canvas, screen_width, screen_height, i):
    ...
    if pe_flag >= len(Instr_Cache) and i > 0:
        canvas.create_text(screen_width/8.17, screen_height/4.67, text="αν", font=("Arial", int(screen_width/215)), fill="red")
    if pe_flag < len(Instr_Cache) and i > 0:
        canvas.create_text(screen_width/8.17, screen_height/4.67, text="αν", font=("Arial", int(screen_width/215)), fill="green")
    else:
    ...
    canvas.create_text(screen_width/5.783, screen_height/4.235, text="κα1", font=("Arial", int(screen_width/215)))
    canvas.create_text(screen_width/5.783, screen_height/3.789, text="κα2", font=("Arial", int(screen_width/215)))
    canvas.create_text(screen_width/5.783, screen_height/2.734, text="κα3", font=("Arial", int(screen_width/215)))
    ...
    canvas.create_text(screen_width/5.783, screen_height/4.7, text="ΚΛ", font=("Arial", int(screen_width/215)))
    #Πολυπλέκτης Β
    ...
    if choose == 3 or choose == 4:
        canvas.create_line(screen_width/4.74, screen_height/2.827, screen_width/3.622 +screen_width/23, screen_height/2.827, arrow="last")
    ...
    if choose == 3 or choose == 4:
        canvas.create_line(screen_width/3.801, screen_height/2.204, screen_width/3.622 +screen_width/23, screen_height/2.204, arrow="last")
    ...
    if choose == 3 or choose == 4:
        #Πολυπλέκτης Α για παροχέτευση
        canvas.create_line(screen_width/3.4716, screen_height/4.9090, screen_width/3.4716, screen_height/3.9272)
        canvas.create_line(screen_width/3.3454, screen_height/4.6956, screen_width/3.3454, screen_height/4.0754)
        canvas.create_line(screen_width/3.4716, screen_height/4.9090, screen_width/3.3454, screen_height/4.6956)
        canvas.create_line(screen_width/3.4716, screen_height/3.9272, screen_width/3.3454, screen_height/4.0754)
        canvas.create_text(screen_width/3.4264, screen_height/4.6351, text="11", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.4264, screen_height/4.4444, text="10", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.4264, screen_height/4.2687, text="01", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.4264, screen_height/4.1064, text="00", font=("Arial", int(screen_width/215)))
        canvas.create_line(screen_width/3.3454, screen_height/4.1064, screen_width/3.1452, screen_height/4.1064, arrow="last")
        canvas.create_text(screen_width/3.45, screen_height/5.3, text="π11", font=("Arial", int(screen_width/274), 'bold'))
        canvas.create_text(screen_width/3.35, screen_height/5.3, text="π10", font=("Arial", int(screen_width/274), 'bold'))
        canvas.create_line(screen_width/3.45, screen_height/5.2, screen_width/3.45, screen_height/4.85, arrow="last")
        canvas.create_line(screen_width/3.35, screen_height/5.2, screen_width/3.35, screen_height/4.75, arrow="last")
        #Πολυπλέκτης Β για παροχέτευση
        canvas.create_line(screen_width/3.4716, screen_height/3.7894, screen_width/3.4716, screen_height/3.1764)
        canvas.create_line(screen_width/3.3454, screen_height/3.6610, screen_width/3.3454, screen_height/3.2727)
        canvas.create_line(screen_width/3.4716, screen_height/3.7894, screen_width/3.3454, screen_height/3.6610)
        canvas.create_line(screen_width/3.4716, screen_height/3.1764, screen_width/3.3454, screen_height/3.2727)
        canvas.create_text(screen_width/3.4264, screen_height/3.6363, text="00", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.4264, screen_height/3.5179, text="01", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.4264, screen_height/3.4069, text="10", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.4264, screen_height/3.3027, text="11", font=("Arial", int(screen_width/215)))
        canvas.create_line(screen_width/3.3454, screen_height/3.6363, screen_width/3.1452, screen_height/3.6363, arrow="last")
        canvas.create_text(screen_width/3.45, screen_height/3.85, text="π21", font=("Arial", int(screen_width/274), 'bold'))
        canvas.create_text(screen_width/3.35, screen_height/3.85, text="π20", font=("Arial", int(screen_width/274), 'bold'))
        #κΕΠ
        canvas.create_rectangle(screen_width/3.63 +screen_width/23, screen_height/12, screen_width/3.42 +screen_width/23, screen_height/2.07)
        canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/4.075, text="(κα1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/3.661, text="(κα2)", font=("Arial", int(screen_width/215)))
        if br == 0:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/10.588, text="Br", font=("Arial", int(screen_width/215)), fill="red")
        elif br == 1:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/10.588, text="Br", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/10.588, text="Br", font=("Arial", int(screen_width/215)))
        if pg1 == 0:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)), fill="red")
        elif pg1 == 1:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/2.827, text="κε", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/2.204, text="δδ", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/2.018, text="κΕΠ", font=("Arial", int(screen_width/215)))
        if al1 == 0:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/4.864, text="ΑΛ1", font=("Arial", int(screen_width/215)), fill="red")
        elif al1 == 1:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/4.864, text="ΑΛ1", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/4.864, text="ΑΛ1", font=("Arial", int(screen_width/215)))
        if al0 == 0:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/5.346, text="ΑΛ0", font=("Arial", int(screen_width/215)), fill="red")
        elif al0 == 1:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/5.346, text="ΑΛ0", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/5.346, text="ΑΛ0", font=("Arial", int(screen_width/215)))
        if dmd1 == 0:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/6.666, text="δΜΔ", font=("Arial", int(screen_width/215)), fill="red")
        elif dmd1 == 1:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/6.666, text="δΜΔ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/6.666, text="δΜΔ", font=("Arial", int(screen_width/215)))
        if gmd1 == 0:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/7.605, text="γΜΔ", font=("Arial", int(screen_width/215)), fill="red")
        elif gmd1 == 1:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/7.605, text="γΜΔ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/7.605, text="γΜΔ", font=("Arial", int(screen_width/215)))
        if gk1 == 0:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)), fill="red")
        elif gk1 == 1:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/3.522 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)))
        #Γραμμή_Καταχωρητές_κΕΠ
        if choose == 3 or choose == 4:
            canvas.create_line(screen_width/3.918, screen_height/4.075, screen_width/3.622+screen_width/83.6363, screen_height/4.075, arrow="last")
            canvas.create_line(screen_width/3.918, screen_height/3.661, screen_width/3.622+screen_width/83.6363, screen_height/3.661, arrow="last")
        else:
        ...
        canvas.create_text(screen_width/3.764, screen_height/4.32, text="(κα1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.764, screen_height/3.857, text="(κα2)", font=("Arial", int(screen_width/215)))
        #ΑΛΜ
        canvas.create_rectangle(screen_width/3.2 +screen_width/23, screen_height/4.59, screen_width/2.95 +screen_width/23, screen_height/3.32)
        canvas.create_text(screen_width/3.072 +screen_width/23, screen_height/3.857, text="ΑΛΜ", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.887 +screen_width/23, screen_height/3.857, text="απ", font=("Arial", int(screen_width/215)))
        #Γραμμή_κΕΠ_ΑΛΜ
        canvas.create_line(screen_width/3.428 +screen_width/23, screen_height/4.075, screen_width/3.2 +screen_width/23, screen_height/4.075, arrow="last")
        canvas.create_line(screen_width/3.428 +screen_width/23, screen_height/3.661, screen_width/3.2 +screen_width/23, screen_height/3.661, arrow="last")
        #Γραμμή_κΕΠ_ΠολυπλέκτηςΑ
        if choose == 3 or choose == 4:
            canvas.create_line(screen_width/3.428 +screen_width/23, screen_height/2.204, screen_width/3.31 +screen_width/23, screen_height/2.204)
            canvas.create_line(screen_width/3.31 +screen_width/23, screen_height/2.204, screen_width/3.31 +screen_width/23, screen_height/1.928)
            canvas.create_line(screen_width/32, screen_height/1.928, screen_width/3.31 +screen_width/23, screen_height/1.928)
            ...
            canvas.create_line(screen_width/32, screen_height/4.075, screen_width/19.2, screen_height/4.075, arrow="last")
        #κΠΜ
        canvas.create_rectangle(screen_width/2.82 +screen_width/23, screen_height/12, screen_width/2.69 +screen_width/23, screen_height/2.16)
        canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/3.724, text="απ", font=("Arial", int(screen_width/215)))
        if pg2 == 0:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)), fill="red")
        elif pg2 == 1:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/4.8, text="(κα1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/3.272, text="(κα2)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/2.827, text="κε", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/2.097, text="κΠΜ", font=("Arial", int(screen_width/215)))
        if dmd2 == 0:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/6.666, text="δΜΔ", font=("Arial", int(screen_width/215)), fill="red")
        elif dmd2 == 1:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/6.666, text="δΜΔ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/6.666, text="δΜΔ", font=("Arial", int(screen_width/215)))
        if gmd2 == 0:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/7.605, text="γΜΔ", font=("Arial", int(screen_width/215)), fill="red")
        elif gmd2 == 1:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/7.605, text="γΜΔ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/7.605, text="γΜΔ", font=("Arial", int(screen_width/215)))
        if gk2 == 0:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)), fill="red")
        elif gk2 == 1:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.754 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)))
        #Γραμμή_ΑΛΜ_κΠΜ
        canvas.create_line(screen_width/2.953 +screen_width/23, screen_height/3.661, screen_width/2.823 +screen_width/23, screen_height/3.661, arrow="last")
        #Γραμμή ΑΛΜ - Πολυπλέκτες Παροχέτευσης
        canvas.create_line(screen_width/2.5734, screen_height/3.6610, screen_width/2.5734, screen_height/2.88)
        canvas.create_line(screen_width/3.6078, screen_height/2.88, screen_width/2.5734, screen_height/2.88)
        canvas.create_line(screen_width/3.6078, screen_height/4.2687, screen_width/3.6078, screen_height/2.88)
        canvas.create_line(screen_width/3.6078, screen_height/4.2687, screen_width/3.4716, screen_height/4.2687, arrow="last")
        canvas.create_line(screen_width/3.6078, screen_height/3.5179, screen_width/3.6078, screen_height/2.88)
        canvas.create_line(screen_width/3.6078, screen_height/3.5179, screen_width/3.4716, screen_height/3.5179, arrow="last")
        #Γραμμή κΠΜ - Πολυπλέκτες Παροχέτευσης
        canvas.create_line(screen_width/2.3232, screen_height/2.4, screen_width/2.3232, screen_height/1.8947)
        canvas.create_line(screen_width/3.6580, screen_height/1.8947, screen_width/2.3232, screen_height/1.8947)
        canvas.create_line(screen_width/3.6580, screen_height/4.4444, screen_width/3.6580, screen_height/1.8947)
        canvas.create_line(screen_width/3.6580, screen_height/4.4444, screen_width/3.4716, screen_height/4.4444, arrow="last")
        canvas.create_line(screen_width/3.6580, screen_height/3.4069, screen_width/3.6580, screen_height/1.8947)
        canvas.create_line(screen_width/3.6580, screen_height/3.4069, screen_width/3.4716, screen_height/3.4069, arrow="last")
        #Γραμμή Κρυφή Μνήμη Δεδομένων - Πολυπλέκτες Παροχέτευσης
        canvas.create_line(screen_width/1.9934, screen_height/4.0754, screen_width/1.9934, screen_height/1.9636)
        canvas.create_line(screen_width/3.5728, screen_height/1.9636, screen_width/1.9934, screen_height/1.9636)
        canvas.create_line(screen_width/3.5728, screen_height/3.3027, screen_width/3.5728, screen_height/1.9636)
        canvas.create_line(screen_width/3.5728, screen_height/3.3027, screen_width/3.4716, screen_height/3.3027, arrow="last")
        canvas.create_line(screen_width/3.5728, screen_height/4.6351, screen_width/3.5728, screen_height/1.9636)
        canvas.create_line(screen_width/3.5728, screen_height/4.6351, screen_width/3.4716, screen_height/4.6351, arrow="last")
        #Γραμμή_κΕΠ_κΠΜ
        canvas.create_line(screen_width/3.31 +screen_width/23, screen_height/4.8, screen_width/3.31 +screen_width/23, screen_height/4.075)
        canvas.create_line(screen_width/3.31 +screen_width/23, screen_height/4.8, screen_width/2.823 +screen_width/23, screen_height/4.8, arrow="last")
        canvas.create_line(screen_width/3.31 +screen_width/23, screen_height/3.661, screen_width/3.31 +screen_width/23, screen_height/3.272)
        canvas.create_line(screen_width/3.31 +screen_width/23, screen_height/3.272, screen_width/2.823 +screen_width/23, screen_height/3.272, arrow="last")
        canvas.create_line(screen_width/3.428 +screen_width/23, screen_height/2.827, screen_width/2.823 +screen_width/23, screen_height/2.827, arrow="last")
        #Κρυφή Μνήμη Δεδομένων
        canvas.create_rectangle(screen_width/2.46 +screen_width/23, screen_height/5.6, screen_width/2.2 +screen_width/23, screen_height/3.085)
        canvas.create_text(screen_width/2.327 +screen_width/23, screen_height/4, text="Κρυφή\nΜνήμη\nΔεδομένων", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.327 +screen_width/23, screen_height/4.8, text="είσοδος\nδεδομένων", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.327 +screen_width/23, screen_height/3.272, text="είσοδος\nδιεύθυνσης", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.4 +screen_width/23, screen_height/5.268, text="αν", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.258 +screen_width/23, screen_height/5.268, text="εε", font=("Arial", int(screen_width/215)))
        #Γραμμή_κΠΜ_Κρυφή Μνήμη Δεδομένων
        canvas.create_line(screen_width/2.685 +screen_width/23, screen_height/4.8, screen_width/2.461 +screen_width/23, screen_height/4.8, arrow="last")
        canvas.create_line(screen_width/2.685 +screen_width/23, screen_height/3.272, screen_width/2.461 +screen_width/23, screen_height/3.272, arrow="last")
        canvas.create_text(screen_width/2.635 +screen_width/23, screen_height/5.142, text="(κα1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.635 +screen_width/23, screen_height/3.428, text="(κα2)", font=("Arial", int(screen_width/215)))
        #κΑΑ
        canvas.create_rectangle(screen_width/2.13 +screen_width/23, screen_height/12, screen_width/2.05 +screen_width/23, screen_height/2.18)
        canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/2.117, text="κΑΑ", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/2.4, text="απ", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/2.827, text="κε", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/4.075, text="δε", font=("Arial", int(screen_width/215)))
        if pg3 == 0:
            canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)), fill="red")
        elif pg3 == 1:
            canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/5.934, text="πΓ", font=("Arial", int(screen_width/215)))
        if gk3 == 0:
            canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)), fill="red")
        elif gk3 == 1:
            canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.091 +screen_width/23, screen_height/8.852, text="γΚ", font=("Arial", int(screen_width/215)))
        #Γραμμή_Κρυφή Μνήμη Δεδομένων_κΑΑ
        canvas.create_line(screen_width/2.199 +screen_width/23, screen_height/4.075, screen_width/2.126 +screen_width/23, screen_height/4.075, arrow="last")
        canvas.create_text(screen_width/2.169 +screen_width/23, screen_height/4.32, text="δε", font=("Arial", int(screen_width/215)))
        #Γραμμή_κΠΜ_κΑΑ
        canvas.create_line(screen_width/2.685 +screen_width/23, screen_height/3.724, screen_width/2.585 +screen_width/23, screen_height/3.724)
        canvas.create_line(screen_width/2.585 +screen_width/23, screen_height/3.724, screen_width/2.585 +screen_width/23, screen_height/2.4)
        canvas.create_line(screen_width/2.585 +screen_width/23, screen_height/2.4, screen_width/2.133 +screen_width/23, screen_height/2.4, arrow="last")
        canvas.create_line(screen_width/2.685 +screen_width/23, screen_height/2.827, screen_width/2.133 +screen_width/23, screen_height/2.827, arrow="last")
        #Πολυπλέκτης Γ
        canvas.create_line(screen_width/1.979 +screen_width/23, screen_height/4.5, screen_width/1.979 +screen_width/23, screen_height/3.48)
        canvas.create_line(screen_width/1.92 +screen_width/23, screen_height/4.15, screen_width/1.92 +screen_width/23, screen_height/3.72)
        canvas.create_line(screen_width/1.979 +screen_width/23, screen_height/4.5, screen_width/1.92 +screen_width/23, screen_height/4.15)
        canvas.create_line(screen_width/1.979 +screen_width/23, screen_height/3.48, screen_width/1.92 +screen_width/23, screen_height/3.72)
        canvas.create_text(screen_width/1.959 +screen_width/23, screen_height/4.075, text="0", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/1.959 +screen_width/23, screen_height/3.724, text="1", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/1.933 +screen_width/23, screen_height/3.927, text="Γ", font=("Arial", int(screen_width/215)))
        #Γραμμή_κΑΑ_ΠολυπλέκτηςΓ
        canvas.create_line(screen_width/2.049 +screen_width/23, screen_height/4.075, screen_width/1.979 +screen_width/23, screen_height/4.075, arrow="last")
        canvas.create_line(screen_width/2.049 +screen_width/23, screen_height/2.4, screen_width/2.004 +screen_width/23, screen_height/2.4)
        canvas.create_line(screen_width/2.004 +screen_width/23, screen_height/3.698, screen_width/2.004 +screen_width/23, screen_height/2.4)
        canvas.create_line(screen_width/2.004 +screen_width/23, screen_height/3.698, screen_width/1.979 +screen_width/23, screen_height/3.698, arrow="last")
        canvas.create_text(screen_width/2.021 +screen_width/23, screen_height/4.32, text="δε", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/1.979 +screen_width/23, screen_height/3.085, text="απ", font=("Arial", int(screen_width/215)))
        if pg3 == 0:
            canvas.create_text(screen_width/2.021 +screen_width/23, screen_height/6.352, text="πΓ", font=("Arial", int(screen_width/215)), fill="red")
        elif pg3 == 1:
            canvas.create_text(screen_width/2.021 +screen_width/23, screen_height/6.352, text="πΓ", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.021 +screen_width/23, screen_height/6.352, text="πΓ", font=("Arial", int(screen_width/215)))
        #Γραμμή_κΑΑ_Καταχωρητές
        canvas.create_line(screen_width/1.8860, screen_height/2.827, screen_width/1.7066, screen_height/2.827)
        canvas.create_line(screen_width/1.7066, screen_height/54, screen_width/1.7066, screen_height/2.827)
        canvas.create_line(screen_width/4.8, screen_height/54, screen_width/1.7066, screen_height/54)
        ...
        canvas.create_line(screen_width/1.7777, screen_height/3.927, screen_width/1.7454, screen_height/3.927)
        canvas.create_line(screen_width/1.7454, screen_height/27, screen_width/1.7454, screen_height/3.927)
        canvas.create_line(screen_width/4.085, screen_height/27, screen_width/1.7454, screen_height/27)
        ...
        canvas.create_text(screen_width/3.522, screen_height/4.075, text="(κα1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.522, screen_height/3.661, text="(κα2)", font=("Arial", int(screen_width/215)))
        if br == 0:
        ...
        canvas.create_text(screen_width/2.754, screen_height/4.8, text="(κα1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.754, screen_height/3.272, text="(κα2)", font=("Arial", int(screen_width/215)))
        ...
        canvas.create_text(screen_width/2.635, screen_height/5.142, text="(κα1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.635, screen_height/3.428, text="(κα2)", font=("Arial", int(screen_width/215)))
        #κΑΑ
    ...
    if choose == 3 or choose == 4:
        ...
        canvas.create_line(screen_width/5.783, screen_height/1.8, screen_width/3.522+screen_width/23, screen_height/1.8, arrow="both")
        canvas.create_line(screen_width/3.522+screen_width/23, screen_height/1.8, screen_width/2.754+screen_width/23, screen_height/1.8, arrow="both")
        canvas.create_line(screen_width/2.754+screen_width/23, screen_height/1.8, screen_width/2.091+screen_width/23, screen_height/1.8, arrow="both")
        canvas.create_line(screen_width/2.091+screen_width/23, screen_height/1.8, screen_width/1.828+screen_width/23, screen_height/1.8, arrow="both")
        canvas.create_text(screen_width/9.846, screen_height/1.846, text="ΠΕ (Βαθμίδα 1)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/4.363+screen_width/36, screen_height/1.846, text="ΑΕ (Βαθμίδα 2)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/3.096+screen_width/23, screen_height/1.846, text="ΕΠ (Βαθμίδα 3)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/2.385+screen_width/23, screen_height/1.846, text="ΠΜ (Βαθμίδα 4)", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/1.949+screen_width/23, screen_height/1.846, text="ΑΑ (Βαθμίδα 5)", font=("Arial", int(screen_width/215)))
    else:
        canvas.create_line(screen_width/32, screen_height/1.8, screen_width/5.783, screen_height/1.8, arrow="both")
    ...
    if choose == 3 or choose == 4:
        canvas.create_line(screen_width/16.2711, screen_height/21.6, screen_width/27.4285, screen_height/21.6, arrow="last")
        canvas.create_line(screen_width/17.1428, screen_height/18, screen_width/27.42, screen_height/18, arrow="last")
        canvas.create_text(screen_width/32, screen_height/21.6, text="σ1", font=("Arial", int(screen_width/215)))
        canvas.create_text(screen_width/32, screen_height/18, text="σ2", font=("Arial", int(screen_width/215)))
    #Γραμμή_κΑΕ_Μονάδα Ελέγχου
    ...
    if choose == 3 or choose == 4:
        canvas.create_line(screen_width/3.416 +screen_width/23, screen_height/10.588, screen_width/3.096 +screen_width/23, screen_height/10.588)
        canvas.create_line(screen_width/3.096 +screen_width/23, screen_height/14.4, screen_width/3.096 +screen_width/23, screen_height/10.588)
        canvas.create_line(screen_width/3.096 +screen_width/23, screen_height/14.4, screen_width/3.2, screen_height/14.4, arrow="last")
        canvas.create_line(screen_width/2.949 +screen_width/23, screen_height/4.5, screen_width/2.9 +screen_width/23, screen_height/4.5)
        canvas.create_line(screen_width/2.9 +screen_width/23, screen_height/16.615, screen_width/2.9 +screen_width/23, screen_height/4.5)
        canvas.create_line(screen_width/2.9 +screen_width/23, screen_height/16.615, screen_width/3.2, screen_height/16.615, arrow="last")
        if ap0 == 0:
            canvas.create_text(screen_width/2.823 +screen_width/23, screen_height/15.428, text="απ0", font=("Arial", int(screen_width/215)), fill="red")
        elif ap0 == 1:
            canvas.create_text(screen_width/2.823 +screen_width/23, screen_height/15.428, text="απ0", font=("Arial", int(screen_width/215)), fill="green")
        else:
            canvas.create_text(screen_width/2.823 +screen_width/23, screen_height/15.428, text="απ0", font=("Arial", int(screen_width/215)))
    else:
    ...
    if choose == 3 or choose == 4:
        canvas.create_line(screen_width/3.416+screen_width/23, screen_height/8.852, screen_width/2.823+screen_width/23, screen_height/8.852, dash=(1,1), arrow="last") #κΕΠ_γΚ
        canvas.create_line(screen_width/3.416+screen_width/23, screen_height/7.605, screen_width/2.823+screen_width/23, screen_height/7.605, dash=(1,1), arrow="last") #κΕΠ_γΜΔ
        canvas.create_line(screen_width/3.416+screen_width/23, screen_height/6.666, screen_width/2.823+screen_width/23, screen_height/6.666, dash=(1,1), arrow="last") #κΕΠ_δΜΔ
        canvas.create_line(screen_width/3.416+screen_width/23, screen_height/5.934, screen_width/2.823+screen_width/23, screen_height/5.934, dash=(1,1), arrow="last") #κΕΠ_πΓ
        canvas.create_line(screen_width/3.416+screen_width/23, screen_height/5.346, screen_width/3+screen_width/23, screen_height/5.346, dash=(1,1)) #κΕΠ_ΑΛΟ
        canvas.create_line(screen_width/3+screen_width/23, screen_height/5.346, screen_width/3+screen_width/23, screen_height/4.595, dash=(1,1), arrow="last")
        canvas.create_line(screen_width/3.416+screen_width/23, screen_height/4.864, screen_width/3.147+screen_width/23, screen_height/4.864, dash=(1,1)) #κΕΠ_ΑΛ1
        canvas.create_line(screen_width/3.147+screen_width/23, screen_height/4.864, screen_width/3.147+screen_width/23, screen_height/4.595, dash=(1,1), arrow="last")
        canvas.create_line(screen_width/2.685+screen_width/23, screen_height/8.852, screen_width/2.133+screen_width/23, screen_height/8.852, dash=(1,1), arrow="last") #κΠΜ_γΚ
        canvas.create_line(screen_width/2.685+screen_width/23, screen_height/5.934, screen_width/2.133+screen_width/23, screen_height/5.934, dash=(1,1), arrow="last") #κΠΜ_πΓ
        canvas.create_line(screen_width/2.685+screen_width/23, screen_height/7.605, screen_width/2.258+screen_width/23, screen_height/7.605, dash=(1,1)) #κΠΜ_γΜΔ
        canvas.create_line(screen_width/2.258+screen_width/23, screen_height/7.605, screen_width/2.258+screen_width/23, screen_height/5.684, dash=(1,1), arrow="last")
        canvas.create_line(screen_width/2.685+screen_width/23, screen_height/6.666, screen_width/2.4+screen_width/23, screen_height/6.666, dash=(1,1)) #κΠΜ_δΜΔ
        canvas.create_line(screen_width/2.4+screen_width/23, screen_height/6.666, screen_width/2.4+screen_width/23, screen_height/5.684, dash=(1,1), arrow="last")
        canvas.create_line(screen_width/2.042+screen_width/23, screen_height/5.934, screen_width/1.949+screen_width/23, screen_height/5.934, dash=(1,1)) #κΑΑ_πΓ
        canvas.create_line(screen_width/1.949+screen_width/23, screen_height/5.934, screen_width/1.949+screen_width/23, screen_height/4.32, dash=(1,1), arrow="last")
        canvas.create_line(screen_width/2.042+screen_width/23, screen_height/8.852, screen_width/2+screen_width/23, screen_height/8.852, dash=(1,1)) #κΑΑ_γΚ
        canvas.create_line(screen_width/2+screen_width/23, screen_height/21.6, screen_width/2+screen_width/23, screen_height/8.852, dash=(1,1))
        canvas.create_line(screen_width/4.363, screen_height/21.6, screen_width/2+screen_width/23, screen_height/21.6, dash=(1,1))
    else:
    ...
    if pe_flag >= len(Instr_Cache):
        canvas.create_text(screen_width/8.17, screen_height/6.171, text="0", font=("Arial", int(screen_width/215)))
    else:
