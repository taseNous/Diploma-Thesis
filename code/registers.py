# This file is responsible for the window of register management
...
def create_button2_window(menu_window):
    ...
    tk.Label(button2_window, text="Register", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.02), y=int(screen_height * 0.15))
    tk.Label(button2_window, text="Reference Code", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.135), y=int(screen_height * 0.15))
    tk.Label(button2_window, text="Value", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.28), y=int(screen_height * 0.15))
    tk.Label(button2_window, text="Content", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.37), y=int(screen_height * 0.15))

    tk.Label(button2_window, text="Register", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.475), y=int(screen_height * 0.15))
    tk.Label(button2_window, text="Reference Code", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.59), y=int(screen_height * 0.15))
    tk.Label(button2_window, text="Value", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.73), y=int(screen_height * 0.15))
    tk.Label(button2_window, text="Content", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.82), y=int(screen_height * 0.15))
    ...
    append_button = tk.Button(button2_window, text="Add Values", font=("Arial", int(14 * font_scale)), fg="black", bg="#61afef", activebackground="#4fa3e2", activeforeground="white", command=append_values)
    ...
    exit_button = tk.Button(button2_window, text="Exit", font=("Arial", int(14 * font_scale)), bg="#ff6666", fg="black", activebackground="#cc0000", activeforeground="white", command=lambda: close_button2_open_menu())
