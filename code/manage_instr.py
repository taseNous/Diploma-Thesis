...
from vars import r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, none, d
import gui_vars, vars
...
def create_button1_window(menu_window, screen_width, screen_height):
    ...
    left_header = tk.Label(left_frame, text="Εντολές στην Κρυφή Μνήμη Εντολών", font=("Arial", int(int(screen_width/106.6666))), bg='#2E2E2E', fg="white")
    left_header.grid(row=0, column=0, columnspan=3, pady=int(screen_height/108))

    command_label = tk.Label(left_frame, text="Πόσες εντολές θέλετε να προσθέσετε;", font=("Arial", int(int(screen_width/137.1428))), bg='#2E2E2E', fg="white")
    ...
    add_button = tk.Button(left_frame, text="Προσθήκη", font=("Arial", int(screen_width/137.1428)), fg="black", bg= "#61afef", activebackground="#4fa3e2", activeforeground="white", command=lambda: create_dynamic_rows_from_cache(left_frame))
    add_button.grid(row=2, column=2, pady=int(screen_height/216))
    add_button.bind("<Enter>", on_enter)
    add_button.bind("<Leave>", on_leave)

    # Position insertion input
    position_label = tk.Label(left_frame, text="Σε ποια σειρά θέλετε να τη τοποθετήσετε;", font=("Arial", int(screen_width/137.1428)), bg='#2E2E2E', fg="white")
    ...
    add_button1 = tk.Button(left_frame, text="Προσθήκη", font=("Arial", int(screen_width/137.1428)), fg="black", bg= "#61afef", activebackground="#4fa3e2", activeforeground="white")
    ...
    number_header = tk.Label(left_frame, text="Αριθμός", font=("Arial", int(screen_width/137.1428)), bg='#2E2E2E', fg="white", width=int(screen_width/128))
    instruction_header = tk.Label(left_frame, text="Εντολή", font=("Arial", int(screen_width/137.1428)), bg='#2E2E2E', fg="white", width=int(screen_width/128))
    registers_header = tk.Label(left_frame, text="Καταχωρητές", font=("Arial", int(screen_width/137.1428)), bg='#2E2E2E', fg="white", width=int(screen_width/128))
    action_header = tk.Label(left_frame, text="Ενέργεια", font=("Arial", int(screen_width/137.1428)), bg='#2E2E2E', fg="white", width=int(screen_width/128))
    ...
    right_header1 = tk.Label(right_frame, text="Προσθήκη Εντολών", font=("Arial", int(screen_width/106.6666)), bg='#2E2E2E', fg="white")
    ...
    metatopisi_label = tk.Label(right_frame, text="Μετατόπιση", font=("Arial", int(screen_width/106.6666)), bg='#2E2E2E', fg="white")
    ...
    append_button = tk.Button(content_frame, text="Καταχώρηση Εντολών", font=("Arial", int(screen_width/137.1428)), fg="black", bg= "#61afef", activebackground="#4fa3e2", activeforeground="white", command=append_and_display)
    ...
    exit_button = tk.Button(content_frame, text="Έξοδος", font=("Arial", int(screen_width/137.1428)), bg="#ff6666", fg="black", activebackground="#cc0000", activeforeground="white",command=lambda: close_button1_open_menu())
