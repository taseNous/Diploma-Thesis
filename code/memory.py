...
def create_button3_window(menu_window=None, show_menu_function=None, canvas=None):
    ...
    tk.Label(button3_window, text="Θέση Μνήμης", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.02), y=int(screen_height * 0.05))
    tk.Label(button3_window, text="Διεύθυνση", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.125), y=int(screen_height * 0.05))
    tk.Label(button3_window, text="Τιμή", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.28), y=int(screen_height * 0.05))
    tk.Label(button3_window, text="Περιεχόμενο", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.37), y=int(screen_height * 0.05))

    tk.Label(button3_window, text="Θέση Μνήμης", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.475), y=int(screen_height * 0.05))
    tk.Label(button3_window, text="Διεύθυνση", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.575), y=int(screen_height * 0.05))
    tk.Label(button3_window, text="Τιμή", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.73), y=int(screen_height * 0.05))
    tk.Label(button3_window, text="Περιεχόμενο", font=("Arial", int(18 * font_scale)), fg="white", bg="#2E2E2E").place(x=int(screen_width * 0.82), y=int(screen_height * 0.05))
    ...
    append_button = tk.Button(button3_window, text="Καταχώρηση Τιμών", font=("Arial", int(14 * font_scale)), fg="black", bg="#61afef", activebackground="#4fa3e2", activeforeground="white", command=append_values)
    ...
    exit_button = tk.Button(button3_window, text="Έξοδος", font=("Arial", int(14 * font_scale)), bg="#ff6666", fg="black", activebackground="#cc0000", activeforeground="white", command=lambda: close_button3_open_menu())
