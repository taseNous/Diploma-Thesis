# Functions to find the dependencies between instructions (hazards) for each method

import gui_vars, table_instructions, cycles, method

from vars import index1, index3, index4, index5, index6, index7, index8, index_bypass_instr, index_bypass_cycle, index_bypass_cycle1, index_bypass_cycle2
...
def depend_nop(i, q):
    ...
    global p11, p22, p33, Instr_Cache1
...
def depend_freeze(i, q):
    ...
    global p11, p22, p33, p44, current_y, Instr_Cache1
    Instr_Cache = gui_vars.Instr_Cache
